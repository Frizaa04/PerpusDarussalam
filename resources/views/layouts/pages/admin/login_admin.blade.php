                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" required
                            class="w-full pl-10 pr-10 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-[#00695c] focus:border-[#00695c] outline-none text-sm transition bg-white"
                            placeholder="Masukan Kata Sandi">
                        <button type="button" onclick="togglePassword('password', 'toggleIconAdmin')" class="absolute right-3 top-2.5 text-slate-400 hover:text-slate-600 focus:outline-none">
                            <span id="toggleIconAdmin" class="material-icons text-xl select-none">visibility_off</span>
                        </button>
                    </div>
                </div>
