    ...
    <div class="max-w-md w-full bg-white rounded-xl shadow-xl overflow-hidden border border-emerald-100">
        ...
        <div class="p-8 space-y-6">
            ...
            <form action="{{ route('user.login.post') }}" method="POST" class="space-y-5">
                ...
                <!-- Input Username / Email / NIK / NISN -->
                <div>
                    <label for="username" class="block text-sm font-semibold text-gray-700 mb-1">Email / NIK / NISN</label>
                    <div class="relative">
                        ...
                        <input type="text" name="username" id="username" required value="{{ old('username') }}"
                            ...
                            placeholder="masukkan email / NIK / NISN anda...">
                    </div>
                </div>
