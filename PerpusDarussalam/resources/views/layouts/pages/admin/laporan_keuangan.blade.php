        ...
        <div class="p-8 space-y-8">
            ...
            @if(!$category)
                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <!-- Kiri: Tombol Mode (Harian / Mingguan), Label Bulan, dan Tanggal -->
                    <div class="flex flex-wrap items-center gap-3">
                        
                        <!-- Toggle Tombol Harian / Mingguan -->
                        <div class="inline-flex bg-[#004d40] p-1 rounded-lg border border-[#004d40] shadow-sm">
                            <a href="{{ route('laporan.keuangan', ['date' => $selectedDate, 'mode' => 'harian']) }}" 
                            ...
                            <a href="{{ route('laporan.keuangan', ['date' => $selectedDate, 'mode' => 'mingguan']) }}" 
                        ...
                        <form action="{{ route('laporan.keuangan') }}" method="GET" class="flex items-center relative">
            ...
            @else
                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('laporan.keuangan', ['date' => $selectedDate, 'mode' => $mode]) }}" 
                        ...
                        <div class="bg-[#004d40] text-amber-300 px-5 py-2 rounded font-bold text-sm shadow">
                            Total: Rp. {{ number_format($totalCategory, 0, ',', '.') }}
                        </div>

                        <button onclick="window.print()" class="bg-[#004d40] text-white p-2 rounded hover:bg-[#003d30] transition shadow flex items-center" title="Cetak / Print Laporan">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
