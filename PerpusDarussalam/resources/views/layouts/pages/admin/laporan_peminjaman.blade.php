                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <form action="{{ route('laporan.peminjaman') }}" method="GET" class="flex items-center relative">
                            ...
                            <button type="button" onclick="document.getElementById('date-picker-peminjaman').showPicker()"
                            ...
                            <input type="date" id="date-picker-peminjaman" name="date"
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('laporan.index', ['date' => $selectedDate->format('Y-m-d'), 'mode' => $mode]) }}"
